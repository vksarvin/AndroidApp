...
private const val ARG_PARAM2 = "reservationStatus"

/**
 * A simple [Fragment] subclass.
 * Activities that contain this fragment must implement the
 * [HouseKeepingDetailFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [HouseKeepingDetailFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class HouseKeepingDetailFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.fragment_house_keeping_detail, container, false)
        mShimmerViewContainer = view.findViewById(R.id.shimmer_view_container)
        val housekeepingdetail = view.findViewById<LinearLayout>(R.id.housekeeping_detail)
        ...
        houseKeepingDetailViewModel!!.housekeepingdetail.observe(this, Observer { t: JSONArray? ->
            if(t == null){
                housekeepingdetail!!.visibility = View.GONE
                Toast.makeText(context,"No Data",Toast.LENGTH_SHORT).show()
            }else{
                housekeepingdetail!!.visibility = View.VISIBLE
    ...
    companion object {
         ...
         * @return A new instance of fragment HouseKeepingDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: Int, param2: String) =
                HouseKeepingDetailFragment().apply {
